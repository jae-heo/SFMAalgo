...
public class MSR5 extends mainPackage.v2.tests.Test {
    ...
    public MSR5() {
        ...
        Node node0 = Node.builder()
                ...
                .imageFileName("5_15")
                .build()
                .addChild(FN, Child.builder().color(BLUE).description("경골 외회전 가동성 정상")
    ...
    public static Test getInstance() {
        if (MSR5.instance == null) { MSR5.instance = new MSR5();}
        return instance;
    }
}
