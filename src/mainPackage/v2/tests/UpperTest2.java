...
public class UpperTest2 extends mainPackage.v1.tests.Test {
    ...
    public UpperTest2() {
        ...
        Node node3 = Node.builder()
                ...
                .imageFileName("2_13")
                .build()
                .addChild("O", Child.builder().description("패턴2을 위한 분리된 자세 &/ or 어깨대 SMCD. 척추신전 하위 검사로 간다.").nextTest1(mainPackage.v1.tests.MultiExtension1.getInstance().getHead()).build())
