package mainPackage.tests;//package mainPackage.tests;
//
//
...
//                .O(new Child("결과가 아직 없다면, 패턴1의 복합 JMD", null, null))
...
//                .O(new Child("어깨신전 SMCD", node8, null))
//                .X(new Child("어깨 신전 JMD or TED", node8, null))
...
//                .O(new Child("어깨 내회전 SMCD", node6, null))
//                .X(new Child("어깨 내회전 JMD or TED", node6, null))
...
//                .O(new Child("패턴1을 위한 분리된 자세 &/ or 어깨대 SMCD. 척추신전 하위 검사로 간다.", null, null))
//                .X(new Child("패턴1의 기능적 어깨 패턴 SMCD. 척추신전 하위 검사로 간다.", null, null))
//                .P(new Child("통증 치료", null, null))
//                .imageFileName("2_3")
//                .build();
//
