...
public class UpperTest2 extends Test {
    ...
    public UpperTest2() {
        ...
        Node node3 = Node.builder()
                ...
                .imageFileName("2_13")
                .build()
                .addChild("O", Child.builder().description("패턴2을 위한 분리된 자세 &/ or 어깨대 SMCD. 척추신전 하위 검사로 간다.").build())
                .addChild("X", Child.builder().description("패턴2의 기능적 어깨 패턴 SMCD. 척추신전 하위 검사로 간다.").build())
                .addChild("P", Child.builder().description("통증 치료").build());
