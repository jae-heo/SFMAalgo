    ...
    public MultiExtension1() {
        Node node8 = Node.builder()
                ...
                .addChild("O", Child.builder().description("흉추 신전 SMCD가 있으면 요추는 정상이고. 없으면 -" +
                        "체중지지 척추 회전 SMCD - 상체 & 하체 신전 차트로").nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
                .addChild("X", Child.builder().description("펀더먼털 척추 신전 SMCD - 상체 & 하체 신전 차트로")
                .nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
                .addChild("P", Child.builder().description("통증 치료 - 상체 & 하체 신전 차트로")
                .nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build());
        ...
        Node node7 = Node.builder()
                ...
                .addChild("X1", Child.builder().description("요추 한쪽 신전/ 회전 JMD &/ or TED - 상체 & 하체 " +
                        "신전 차트로 ").nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
        ...
        Node node5 = Node.builder()
                ...
                .addChild("X1", Child.builder().description("흉추 한쪽 신전 JMD &/or TED - 상체 & 하체 신전 차트로")
                        .nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
                .addChild("X2", Child.builder().description("흉추 양쪽 신전 JMD &/or TED - 상체 & 하체 신전 차트로")
                .nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
        ...
        Node node3 = Node.builder()
                ...
                .addChild("O", Child.builder().description("신전이 기능적이고 통증이 없다면 - 체중 지지 척추 신전 SMCD이다," +
                        " 하지만 계속 상체 & 하체 신전 차트로 이동한다.").nextTest1(MultiExtension3.getInstance().getHead()).nextTest2(MultiExtension2.getInstance().getHead()).build())
        ...
        Node node2 = Node.builder()
                ...
                .addChild("O", Child.builder().description("양쪽 기능적이고 통증이 없다. 대칭 스텐스코어 SMCD or" +
                        " 전방 흉곽 TED. - 상체 신전 차트로").nextTest1(MultiExtension2.getInstance().getHead()).build())
        ...
        Node node1 = Node.builder()
                ...
                .imageFileName("4_1")
                .build()
                .addChild("O", Child.builder().description("상체 신전 차트로 이동한다.").nextTest1(MultiExtension2.getInstance().getHead()).build())
