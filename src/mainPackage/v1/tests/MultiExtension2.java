...
public class MultiExtension2 extends Test {
    ...
    public MultiExtension2() {
        Node node6 = Node.builder()
                ...
                .imageFileName("4_11")
                .build()
                .addChild("O", Child.builder().description("코어 SMCD &/or 능동 고관절 신전 SMCD").build())
                .addChild("X", Child.builder().description("펀더먼털 신전패턴 SMCD").build())
        ...
        Node node5 = Node.builder()
                ...
                .imageFileName("4_11")
                .build()
                .addChild("O", Child.builder().description("고관절 신전 기능제한의 표시가 있으면 체중지지 고관절 &/or" +
        ...
        Node node4 = Node.builder()
                ...
                .addChild("X", Child.builder().description("고관절 신전 JMD &/or TED").build())
                .addChild("P", Child.builder().description("통증치료").build());
        ...
        Node node2 = Node.builder()
                ...
                .addChild("O1", Child.builder().description("하부 전방 사슬 TED").build())
                .addChild("O2", Child.builder().description("하부 외측 사슬 TED").build())
                .addChild("O3", Child.builder().description("하부 전방 및 외측 사슬 TED").build())
                .addChild("X", Child.builder().description("고관절 신전 JMD &/or TED and/or 코어 SMCD").build())
                .addChild("P", Child.builder().description("통증치료").build());
        ...
        Node node1 = Node.builder()
                ...
                .addChild("X_P", Child.builder().node(node2).description("고관절/SI JMD &/or TED &/or 코어 SMCD" +
